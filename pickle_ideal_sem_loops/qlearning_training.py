...
def next_step(q_table, enviroment, action, state, old_state, goal_state): #verificar se tomando uma nova decisão não tomei a mesma anteriormente pra evitar caminhos longos
